...
public class Resources {
	...
	public static final int PLATFORM_ACCELERATION = 2;
	public static final int PLATFORM_VELOCITY_CAP = 7;
	public static final double FRICTION = 0.98;
	public static final int BALL_DIAMETER = PLATFORM_HEIGHT;
	public static final int BRICK1_WIDTH = 70;
	public static final int BRICK1_HEIGHT = 15;
